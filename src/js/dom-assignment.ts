...
document.addEventListener('DOMContentLoaded', () => {
  const mainContainer = document.querySelector<HTMLElement>('.cmp-main-container');
  const sectionTemplate =document.querySelector<HTMLTemplateElement>('template#tmp-section');
